...
public class BrokerBookings {
	...
	public BrokerBookings() {
		super();
	}
	public BrokerBookings(String id, String companyCode, String brokerNo, String brokerName, String aadharNo,
			...
			MongoLocalDateTime updatedDt, Bookings bookings) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BrokerBookings [id=" + id + ", companyCode=" + companyCode + ", brokerNo=" + brokerNo + ", brokerName="
